...
:root {
 ...
 --cce-accent:   #6366f1; /* overridden by user settings */
 --cce-glow:     rgba(99,102,241,.25); /* overridden by user settings */
}
...
/* Generic Boxes, Cards & Containers */
body.cce-dark .bg-white, body.cce-dark .card, body.cce-dark .card-body, body.cce-dark .list-group-item,
body.cce-dark .simplesearchform, body.cce-dark .searchbar, body.cce-dark .input-group,
body.cce-dark .box, body.cce-dark .well, body.cce-dark .mform .fitem, body.cce-dark .section .activity,
body.cce-dark .course-content ul.topics li.section, body.cce-dark .popover-region-container,
body.cce-dark .popover-region-footer-container {
...
/* Modals & Popovers */
body.cce-dark .modal-content, body.cce-dark .moodle-dialogue-base .moodle-dialogue-wrap {
  background: var(--cce-bg2) !important;
  border: 1px solid var(--cce-border) !important;
  box-shadow: 0 10px 40px rgba(0,0,0,.6) !important;
}
body.cce-dark .modal-header, body.cce-dark .modal-footer, body.cce-dark .moodle-dialogue-hd, body.cce-dark .moodle-dialogue-ft {
  border-color: var(--cce-border) !important;
  background: var(--cce-bg1) !important;
}
body.cce-dark .popover-region-container { box-shadow: 0 4px 20px rgba(0,0,0,.5) !important; border: 1px solid var(--cce-border) !important; }

/* Dashboard main blocks (Timeline, Recently Accessed) */
body.cce-dark .block_recentlyaccessedcourses, body.cce-dark .block_timeline, body.cce-dark .block_calendar_month,
body.cce-dark .block_myoverview, body.cce-dark .block {
  background: var(--cce-glass) !important;
  backdrop-filter: blur(20px) !important;
...
body.cce-dark input[type="text"], body.cce-dark input[type="search"], body.cce-dark input[type="password"],
body.cce-dark input[type="email"], body.cce-dark .form-control, body.cce-dark input.withclear,
body.cce-dark select, body.cce-dark .custom-select, body.cce-dark textarea {
  background: rgba(255,255,255,.04) !important;
  color: var(--cce-text) !important;
  border: 1px solid var(--cce-border) !important;
  border-radius: 8px !important;
}
body.cce-dark input:focus, body.cce-dark select:focus, body.cce-dark textarea:focus, body.cce-dark .form-control:focus {
  border-color: var(--cce-accent) !important;
  box-shadow: 0 0 0 3px var(--cce-glow) !important;
  outline: none !important;
}
body.cce-dark input::placeholder { color: var(--cce-muted) !important; }

body.cce-dark .btn-primary, body.cce-dark .btn.btn-primary {
  background: var(--cce-accent) !important;
  border-color: var(--cce-accent) !important;
  color: #fff !important;
  box-shadow: 0 2px 10px var(--cce-glow) !important;
}
body.cce-dark .btn-primary:hover { filter: brightness(1.1); box-shadow: 0 4px 15px var(--cce-glow) !important; }

body.cce-dark .btn-secondary, body.cce-dark .btn-outline-secondary, body.cce-dark .btn.btn-outline-secondary {
  background: rgba(255,255,255,.05) !important;
  border-color: var(--cce-border) !important;
  color: var(--cce-muted) !important;
}
body.cce-dark .btn-secondary:hover, body.cce-dark .btn-outline-secondary:hover {
  background: rgba(var(--cce-accent), .12) !important;
  border-color: var(--cce-accent) !important;
  color: var(--cce-text-h) !important;
}

/* Tables */
body.cce-dark table, body.cce-dark .generaltable { color: var(--cce-text) !important; border-color: var(--cce-border) !important; }
body.cce-dark table th, body.cce-dark .generaltable th { background: var(--cce-bg2) !important; color: var(--cce-muted) !important; border-color: var(--cce-border) !important; }
body.cce-dark table td, body.cce-dark .generaltable td { background: var(--cce-bg1) !important; border-color: var(--cce-border) !important; }
body.cce-dark .table-striped tbody tr:nth-of-type(odd) { background-color: rgba(255,255,255,.02) !important; }
body.cce-dark table tr:hover td { background: rgba(255,255,255,.04) !important; }

/* Text & Headings */
body.cce-dark h1, body.cce-dark h2, body.cce-dark h3, body.cce-dark h4, body.cce-dark h5, body.cce-dark h6,
body.cce-dark .card-title, body.cce-dark .coursename, body.cce-dark .text-dark,
body.cce-dark .page-header-headings h1, body.cce-dark .page-context-header h1 {
  color: var(--cce-text-h) !important;
}
body.cce-dark .text-muted, body.cce-dark .dimmed_text { color: var(--cce-muted) !important; }
body.cce-dark a { color: var(--cce-accent) !important; }
body.cce-dark a:hover { color: var(--cce-text-h) !important; }

/* Navbars & Menus */
body.cce-dark .navbar.fixed-top, body.cce-dark nav.navbar, body.cce-dark #page-header, body.cce-dark .secondary-navigation {
...
body.cce-dark .nav-link:hover, body.cce-dark .nav-link.active { color: var(--cce-text-h) !important; }
body.cce-dark .secondary-navigation .nav-tabs { border-color: var(--cce-border) !important; }
body.cce-dark .secondary-navigation .nav-link.active { border-color: var(--cce-accent) !important; color: var(--cce-text-h) !important; }

body.cce-dark .dropdown-menu {
  background: var(--cce-glass) !important;
  border: 1px solid var(--cce-border) !important;
  backdrop-filter: blur(20px) !important;
...
body.cce-dark .dropdown-item:hover { background: rgba(255,255,255,.08) !important; color: var(--cce-text-h) !important; }

/* Drawers & Sidebar */
body.cce-dark .drawer, body.cce-dark [data-region="drawer"], body.cce-dark #nav-drawer, body.cce-dark .block-region {
  background: var(--cce-bg1) !important;
  border-right: 1px solid var(--cce-border) !important;
}
body.cce-dark .list-group-item.active { background: rgba(99,102,241,.15) !important; border-color: transparent !important; color: var(--cce-accent) !important; }

/* Course Cards */
body.cce-dark .course-card {
...
body.cce-dark .course-card:hover {
  transform: translateY(-4px) !important;
  border-color: var(--cce-accent) !important;
  box-shadow: 0 12px 30px rgba(0,0,0,.4), 0 0 12px var(--cce-glow) !important;
}
body.cce-dark .course-card.is-next {
  border-color: var(--nc, var(--cce-accent)) !important;
  box-shadow: 0 0 0 2px var(--nc, var(--cce-accent)), 0 8px 24px rgba(0,0,0,.3) !important;
  animation: cce-nc-pulse 3s ease-in-out infinite;
}
@keyframes cce-nc-pulse {
  0%, 100% { box-shadow: 0 0 0 1px var(--nc, var(--cce-accent)), 0 8px 24px rgba(0,0,0,.3); }
  50% { box-shadow: 0 0 0 3px var(--nc, var(--cce-accent)), 0 12px 32px rgba(0,0,0,.4), 0 0 20px var(--cce-glow); }
}
.cce-next-badge {
  position: absolute; top: 10px; right: 10px;
  background: var(--cce-accent); color: #fff !important;
  padding: 3px 9px; border-radius: 6px; font-size: 9px !important; font-weight: 900 !important;
  letter-spacing: .06em; box-shadow: 0 2px 10px var(--cce-glow); z-index: 5;
  animation: nbpulse 2s ease-in-out infinite;
}
@keyframes nbpulse { 0%, 100% { opacity: 1; } 50% { opacity: .65; } }

/* Fixes for white artifacts */
body.cce-dark .bg-white, body.cce-dark .bg-light, body.cce-dark .bg-gray,
body.cce-dark .generaltable tbody tr:hover, body.cce-dark .tertiary-navigation,
body.cce-dark .message-app, body.cce-dark .header-container, body.cce-dark .footer-container {
  background-color: transparent !important;
}
body.cce-dark .border-bottom, body.cce-dark .border-top, body.cce-dark .border-left, body.cce-dark .border-right {
  border-color: var(--cce-border) !important;
}
